...
def lambda_handler(event, context):
    ...
    order_date = datetime.datetime.strptime(detail['orderDate'], '%Y-%m-%dT%H:%M:%SZ')
    due_date = (order_date + datetime.timedelta(days=7)).strftime('%Y-%m-%dT%H:%M:%SZ')

    result = add_shipment(
        order_date = detail['orderDate'],
        due_date = '2021-10-10T00:00:00Z',
        consignee_name = detail['consigneeName'],
        consignee_address=detail['consigneeAddress'],
        consignee_city=detail['consigneeCity'],
        consignee_state=detail['consigneeState'],
        consignee_postal_code=detail['consigneePostalCode'],
        consignee_phone=detail['consigneePhone'],
        consignee_email=detail['consigneeEmail'],
        purchase_order=detail['purchaseOrder']
    )
