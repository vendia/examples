...
resource "aws_lambda_function" "upb_lambda" {
  # (resource arguments)
  filename      = "../upb/index.js.zip"
  function_name = "vendia-upb-lambda-terraform"
  handler       = "index.handler"
  role          = aws_iam_role.iam_for_lambda.arn
  publish       = true

  source_code_hash = filebase64sha256("../upb/index.js.zip")
...
resource "aws_lambda_function" "delinquent_lambda" {
  # (resource arguments)
  filename      = "../delinquent/index.js.zip"
  function_name = "vendia-delinquent-lambda-terraform"
  handler       = "index.handler"
  role          = aws_iam_role.iam_for_lambda.arn
  publish       = true

  source_code_hash = filebase64sha256("../delinquent/index.js.zip")
...
resource "aws_lambda_function" "wair_lambda" {
  # (resource arguments)
  filename      = "../wair/index.js.zip"
  function_name = "vendia-wair-lambda-terraform"
  handler       = "index.handler"
  role          = aws_iam_role.iam_for_lambda.arn
  publish       = true

  source_code_hash = filebase64sha256("../wair/index.js.zip")
